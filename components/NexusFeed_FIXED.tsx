    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          zIndex: 998, // FIXED: Lowered from 1000
        }}
      ...
      {isOpen && (
        <div
          ...
          style={{
            position: 'fixed', inset: 0, zIndex: 997, // FIXED: Lowered from 999
      ...
      <div style={{
        ...
        height: '100vh', width: '380px', zIndex: 998, // FIXED: Lowered from 1000
        background: '#080e18',
          ...
          {messages.length === 0 ? (
            ...
            messages.map((message) => (
              ...
              >
                ...
                {/* Action footer */}
                {message.requiresAction && !message.actionTaken && (
                  <div style={{
                    marginTop: '12px',
                    ...
                    <button
                      onClick={() => {
                        // Handle action based on message type
                        console.log('Action requested for:', message.type)
                      }}
                      style={{
                        padding: '6px 12px',
                        borderRadius: '6px',
